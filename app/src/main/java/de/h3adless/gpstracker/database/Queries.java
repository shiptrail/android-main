...
//    }
    ...
    public static List<TrackingLocation> getLocationsByTrackID(Context context, long trackID) {
        ...
        while(c.moveToNext()) {
            ...
            loc.altitude = c.getFloat(c.getColumnIndex(TrackDatabase.LocationEntry.COLUMN_NAME_ALTITUDE));
            loc.bearing = c.getFloat(c.getColumnIndex(TrackDatabase.LocationEntry.COLUMN_NAME_BEARING));
